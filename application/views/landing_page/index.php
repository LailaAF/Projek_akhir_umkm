            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0">Aplikasi Fashion Shop</h1>
                            <p class="hero-paragraph">Fashion shop adalah aplikasi yang membantu para umkm di bidang fashion. Fashion shop juga membantu para masyarakat dalam membeli produk-poduk fashion sesuai kebutuhan mereka.</p>
                        </div>
